...
export function DeployPanel() {
  ...
  return (
    <div className="space-y-6 animate-in fade-in slide-in-from-bottom-4 duration-500">
      ...
      {queue.length > 0 && (
        <Accordion type="single" collapsible defaultValue="queue" className="rounded-xl border bg-background px-4">
          <AccordionItem value="queue">
            ...
            <AccordionContent>
              <div className="space-y-2 max-h-[280px] overflow-auto pt-1">
                {queue.map((item) => {
