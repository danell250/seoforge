          ...
          <div className="prose prose-slate max-w-none">
            ...
            <section className="mb-8">
              ...
              <p className="text-muted-foreground leading-relaxed">
                SEOaxe ("we", "our", or "us") is committed to protecting your privacy. This Privacy Policy explains how we collect, use, disclose, and safeguard your information when you use our live SEO audit platform.
              </p>
            </section>
            ...
            <section className="mb-8">
              ...
              <ul className="list-disc pl-5 text-muted-foreground space-y-1 mb-4">
                <li>Website URLs you audit, monitor, or analyze</li>
                <li>Audit history and preferences</li>
            ...
            <section className="mb-8">
              ...
              <ul className="list-disc pl-5 text-muted-foreground space-y-1">
                <li>Provide and maintain our SEO audit services</li>
                <li>Analyze public website pages and generate recommendations using AI</li>
