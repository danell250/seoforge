...
export default function Pricing() {
  useEffect(() => {
    ...
    document.title = "SEOForge Pricing — Free, Starter R299/month, Agency R999/month";
    ...
    metaDesc.setAttribute('content', 'SEOForge pricing: Free plan (3 pages/month), Starter R299/month (20 pages), Agency R999/month (unlimited). All plans include AEO optimization, schema markup, and health scoring.');
        ...
        <div className="container max-w-6xl mx-auto">
          ...
          <div className="mt-24 max-w-4xl mx-auto">
            <div className="text-center mb-10">
              <h2 className="text-3xl font-bold mb-3">Why Businesses Choose SEOForge</h2>
              ...
              <table className="w-full">
                <thead>
                  <tr className="bg-muted/50 border-b">
                    ...
                    <th className="text-center py-4 px-4 font-bold text-primary bg-primary/5 w-1/3">SEOForge</th>
            ...
            <div className="mt-8 p-6 bg-primary/10 border border-primary/20 rounded-xl">
              ...
              <p className="text-muted-foreground text-sm">
                Traditional content tools create new articles. SEOForge fixes your entire website — existing pages, technical SEO, AEO schema, and health scores. That's why our users see rankings improve faster.
              </p>
            </div>
          </div>
