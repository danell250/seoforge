...
export const PLAN_DEFINITIONS: readonly PlanDefinition[] = [
  ...
  },
  {
    ...
    amountUsd: 59,
    period: "month",
    description: "For serious website owners and growing businesses.",
    features: [
